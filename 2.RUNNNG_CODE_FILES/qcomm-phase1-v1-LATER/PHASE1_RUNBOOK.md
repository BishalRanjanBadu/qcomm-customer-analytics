...
| 07 | Model Building and Evaluation | 8–12 min | `models/v_*/`, `models/CURRENT.json` |
...
**07** — both gates:
```
GATE A: PASS      spread ~7.6x   null_p95 ~1.02   ARI ~0.99
GATE B: PASS      test ROC-AUC ~0.80
...
data/customers/01_loaded.parquet ... 07_scored.parquet
data/orders/01_loaded.parquet ... 06_snapshot_d30.parquet
models/CURRENT.json
models/v_<utc>_<sha>/kmeans.pkl, model_b.pkl, feature_names.pkl, manifest.json, metrics.json
